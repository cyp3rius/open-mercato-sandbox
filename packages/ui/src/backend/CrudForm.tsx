...
import { HtmlRichTextEditor } from './richtext/HtmlRichTextEditor'
...
export type CrudFormProps<TValues extends Record<string, unknown>> = {
  ...
  twoColumn?: boolean
  title?: string
  /** Uppercase label above the title (matches FormHeader detail / insurance policy pattern) */
          ...
          {wrapFormBody(
            ...
            <div
              className={hasSecondaryColumn
                ...
                : 'grid grid-cols-1 gap-4'}
            >
              <div data-crud-form-column="1" className="space-y-3">
                {col1Content}
              </div>
              {hasSecondaryColumn ? (
                <div data-crud-form-column="2" className="space-y-3">
                  {col2Content}
                </div>
              ) : null}
            </div>
