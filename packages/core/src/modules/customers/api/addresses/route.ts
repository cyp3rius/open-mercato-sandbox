...
const routeMetadata = {
  GET: {
    requireAuth: true,
    requireAnyFeatures: ['customers.activities.view', 'customers.companies.view', 'customers.people.view'],
  },
  POST: {
    requireAuth: true,
    requireAnyFeatures: ['customers.activities.manage', 'customers.companies.manage', 'customers.people.manage'],
  },
  PUT: {
    requireAuth: true,
    requireAnyFeatures: ['customers.activities.manage', 'customers.companies.manage', 'customers.people.manage'],
