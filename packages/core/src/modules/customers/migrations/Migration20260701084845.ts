...
export class Migration20260701084845 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`alter table if exists "customer_deal_people" add constraint "customer_deal_people_deal_id_foreign" foreign key ("deal_id") references "customer_deals" ("id") on update cascade;`);
    this.addSql(`alter table if exists "customer_deal_people" add constraint "customer_deal_people_person_entity_id_foreign" foreign key ("person_entity_id") references "customer_entities" ("id") on update cascade;`);
    ...
    this.addSql(`alter table if exists "customer_deal_companies" add constraint "customer_deal_companies_deal_id_foreign" foreign key ("deal_id") references "customer_deals" ("id") on update cascade;`);
    this.addSql(`alter table if exists "customer_deal_companies" add constraint "customer_deal_companies_company_entity_id_foreign" foreign key ("company_entity_id") references "customer_entities" ("id") on update cascade;`);

    this.addSql(`alter table if exists "customer_companies" drop constraint if exists "customer_companies_entity_id_foreign";`);
    this.addSql(`alter table if exists "customer_companies" add constraint "customer_companies_entity_id_foreign" foreign key ("entity_id") references "customer_entities" ("id") on update cascade;`);
    ...
    this.addSql(`alter table if exists "customer_comments" add constraint "customer_comments_entity_id_foreign" foreign key ("entity_id") references "customer_entities" ("id") on update cascade;`);
    this.addSql(`alter table if exists "customer_comments" add constraint "customer_comments_deal_id_foreign" foreign key ("deal_id") references "customer_deals" ("id") on update cascade on delete set null;`);

    this.addSql(`alter table if exists "customer_addresses" drop constraint if exists "customer_addresses_entity_id_foreign";`);
    this.addSql(`alter table if exists "customer_addresses" add constraint "customer_addresses_entity_id_foreign" foreign key ("entity_id") references "customer_entities" ("id") on update cascade;`);
    ...
    this.addSql(`alter table if exists "customer_activities" add constraint "customer_activities_entity_id_foreign" foreign key ("entity_id") references "customer_entities" ("id") on update cascade;`);
    this.addSql(`alter table if exists "customer_activities" add constraint "customer_activities_deal_id_foreign" foreign key ("deal_id") references "customer_deals" ("id") on update cascade on delete set null;`);
    ...
    this.addSql(`alter table if exists "customer_interactions" add constraint "customer_interactions_entity_id_foreign" foreign key ("entity_id") references "customer_entities" ("id") on update cascade;`);
    ...
    this.addSql(`alter table if exists "customer_people" add constraint "customer_people_entity_id_foreign" foreign key ("entity_id") references "customer_entities" ("id") on update cascade;`);
    this.addSql(`alter table if exists "customer_people" add constraint "customer_people_company_entity_id_foreign" foreign key ("company_entity_id") references "customer_entities" ("id") on update cascade on delete set null;`);
    ...
    this.addSql(`alter table if exists "customer_tag_assignments" add constraint "customer_tag_assignments_tag_id_foreign" foreign key ("tag_id") references "customer_tags" ("id") on update cascade;`);
    this.addSql(`alter table if exists "customer_tag_assignments" add constraint "customer_tag_assignments_entity_id_foreign" foreign key ("entity_id") references "customer_entities" ("id") on update cascade;`);

    this.addSql(`alter table if exists "customer_todo_links" drop constraint if exists "customer_todo_links_entity_id_foreign";`);
    this.addSql(`alter table if exists "customer_todo_links" add constraint "customer_todo_links_entity_id_foreign" foreign key ("entity_id") references "customer_entities" ("id") on update cascade;`);
  }
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`create table "playbooks_playbooks" ("id" uuid not null default gen_random_uuid(), "tenant_id" uuid not null, "organization_id" uuid not null, "slug" text not null, "title" text not null, "body" text not null, "context_tags" jsonb not null default '[]', "audience" text not null default 'internal', "version" int4 not null default 0, "published_at" timestamptz(6) null, "is_active" bool not null default true, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, "deleted_at" timestamptz(6) null, "procedure_definition" jsonb null, constraint "playbooks_playbooks_pkey" primary key ("id"));`);
    this.addSql(`create index "playbooks_scope_idx" on "playbooks_playbooks" ("tenant_id", "organization_id");`);
    this.addSql(`CREATE UNIQUE INDEX playbooks_slug_version_scope_uidx ON public.playbooks_playbooks USING btree (organization_id, slug, version) WHERE (deleted_at IS NULL);`);
    ...
    this.addSql(`alter table "procurement_process_status_transitions" add constraint "procurement_status_transitions_scope_from_to_uidx" unique ("tenant_id", "organization_id", "from_status_value", "to_status_value");`);
    ...
    this.addSql(`create index "procurement_processes_handler_user_idx" on "procurement_processes" ("handler_user_id");`);
    ...
    this.addSql(`create table "resources_resource_financing_profiles" ("id" uuid not null default gen_random_uuid(), "tenant_id" uuid not null, "organization_id" uuid not null, "resource_id" uuid not null, "financing_kind" text not null, "term_months" int4 null, "vehicle_value_amount" float8 null, "installment_amount" float8 null, "currency_code" text null, "valid_from" timestamptz(6) null, "valid_to" timestamptz(6) null, "metadata" jsonb null, "created_at" timestamptz(6) not null default now(), "updated_at" timestamptz(6) not null default now(), constraint "resources_resource_financing_profiles_pkey" primary key ("id"));`);
    ...
    this.addSql(`CREATE UNIQUE INDEX user_tasks_procurement_process_task_unique ON public.user_tasks USING btree (procurement_process_task_id) WHERE (procurement_process_task_id IS NOT NULL);`);
    ...
    this.addSql(`alter table "cases_timeline_events" add constraint "cases_timeline_events_case_id_foreign" foreign key ("case_id") references "cases_cases" ("id") on update cascade on delete no action;`);
