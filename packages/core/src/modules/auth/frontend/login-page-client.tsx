...
import { BrandLogo } from '@open-mercato/ui/backend/BrandLogo'
...
export default function LoginPageClient({ logoSrc, logoAlt, brandName }: LoginPageClientProps) {
  const t = useT()
    ...
    <div className="min-h-svh flex items-center justify-center p-4">
      <Card className="w-full max-w-sm">
        <CardHeader className="flex flex-col items-center gap-4 text-center p-10">
          <BrandLogo src={logoSrc} alt={logoAlt} variant="hero" />
          {brandName ? <h1 className="text-2xl font-semibold">{brandName}</h1> : null}
