...
export class Migration20251114080223 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`alter table if exists "catalog_product_prices" drop constraint if exists "catalog_product_prices_product_id_foreign";`);
    ...
    this.addSql(`alter table if exists "catalog_product_prices" drop constraint if exists "catalog_product_prices_offer_id_foreign";`);
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`drop index if exists "catalog_product_prices_product_scope_idx";`);
