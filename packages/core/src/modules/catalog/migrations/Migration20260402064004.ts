...
export class Migration20260402064004 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`alter table "catalog_product_variant_relations" drop constraint if exists "catalog_product_variant_relations_unique";`);
    ...
    this.addSql(`alter table "catalog_product_variant_prices" drop constraint if exists "catalog_product_variant_prices_unique";`);
  }

  override async down(): Promise<void> {
    this.addSql(`alter table "catalog_products" drop constraint if exists "catalog_products_service_line_id_foreign";`);
