...
export class Migration20251119154651 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`alter table if exists "catalog_product_variant_option_values" drop constraint if exists "catalog_product_variant_option_values_option_value_id_foreign";`);
  }
