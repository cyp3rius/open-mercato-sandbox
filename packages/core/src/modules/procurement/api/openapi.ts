...
const procurementOpenApiFactory = createCrudOpenApiFactory({
  defaultTag: 'Procurement',
...
export function buildProcurementCrudOpenApi(options: CrudOpenApiOptions): OpenApiRouteDoc {
  return procurementOpenApiFactory(options)
}
