...
const buildAccountingCrudOpenApi = createCrudOpenApiFactory({
  defaultTag: 'Accounting',
...
export function createAccountingCrudOpenApi(options: CrudOpenApiOptions): OpenApiRouteDoc {
  return buildAccountingCrudOpenApi(options)
}
