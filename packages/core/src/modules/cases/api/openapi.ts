...
const buildCasesCrudOpenApi = createCrudOpenApiFactory({
  defaultTag: 'Cases',
...
export function createCasesCrudOpenApi(options: CrudOpenApiOptions): OpenApiRouteDoc {
  return buildCasesCrudOpenApi(options)
}
