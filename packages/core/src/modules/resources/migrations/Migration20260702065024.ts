...
export class Migration20260702065024 extends Migration {
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`alter table "resources_resource_financing_profiles" alter column "created_at" type timestamptz(6) using ("created_at"::timestamptz(6));`);
    this.addSql(`alter table "resources_resource_financing_profiles" alter column "created_at" set default now();`);
    this.addSql(`alter table "resources_resource_financing_profiles" alter column "updated_at" type timestamptz(6) using ("updated_at"::timestamptz(6));`);
    this.addSql(`alter table "resources_resource_financing_profiles" alter column "updated_at" set default now();`);

    this.addSql(`alter table "resources_resource_gallery_items" alter column "created_at" type timestamptz(6) using ("created_at"::timestamptz(6));`);
    this.addSql(`alter table "resources_resource_gallery_items" alter column "created_at" set default now();`);
    this.addSql(`alter table "resources_resource_gallery_items" alter column "updated_at" type timestamptz(6) using ("updated_at"::timestamptz(6));`);
    this.addSql(`alter table "resources_resource_gallery_items" alter column "updated_at" set default now();`);
  }
