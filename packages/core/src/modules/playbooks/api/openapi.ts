...
const buildPlaybooksCrudOpenApi = createCrudOpenApiFactory({
  defaultTag: 'Playbooks',
...
export function createPlaybooksCrudOpenApi(options: CrudOpenApiOptions): OpenApiRouteDoc {
  return buildPlaybooksCrudOpenApi(options)
}
