...
const insuranceOpenApiFactory = createCrudOpenApiFactory({
...
export function buildInsuranceCrudOpenApi(options: CrudOpenApiOptions): OpenApiRouteDoc {
  return insuranceOpenApiFactory(options)
}
