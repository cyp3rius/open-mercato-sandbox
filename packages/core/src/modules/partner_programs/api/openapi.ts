...
const buildPartnerProgramsCrudOpenApi = createCrudOpenApiFactory({
  defaultTag: 'Partner programs',
...
export function createPartnerProgramsCrudOpenApi(options: CrudOpenApiOptions): OpenApiRouteDoc {
  return buildPartnerProgramsCrudOpenApi(options)
}
