...
export class Migration20260105114201 extends Migration {
  ...
  override async down(): Promise<void> {
    this.addSql(`alter table if exists "exchange_rates" drop constraint if exists "exchange_rates_pair_datetime_source_type_unique";`);
