...
export const setup: ModuleSetupConfig = {
  defaultRoleFeatures: {
    ...
    employee: [
      ...
      'sales.orders.create.notify',
      'sales.simple_orders.view',
      'sales.simple_orders.manage',
      'sales.widgets.new-orders',
      'sales.widgets.new-quotes',
      'sales.quotes.view',
      'sales.quotes.manage',
      'sales.quotes.create.notify',
      'sales.quotes.expiring.notify',
      'sales.simple_quotes.view',
      'sales.simple_quotes.manage',
      'sales.shipments.manage',
      'sales.payments.manage',
      'sales.payments.received.notify',
      'sales.returns.view',
