    ...
    list: {
      ...
      transformItem: (item: any) => {
        ...
        const base = {
          ...
          referringPartnerEntityId: item.referring_partner_entity_id ?? null,
          referringPartnerProgramId: item.referring_partner_program_id ?? null,
