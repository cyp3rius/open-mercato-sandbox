...
import { tripCompleteSchema } from '@/modules/taxi_fleet/data/validators'
...
export const openApi = {
  POST: {
    ...
    tags: ['Taxi fleet'],
    requestBody: { schema: tripCompleteSchema },
