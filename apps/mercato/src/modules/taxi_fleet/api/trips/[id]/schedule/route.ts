...
import { tripScheduleSchema } from '@/modules/taxi_fleet/data/validators'
...
export const openApi = {
  POST: {
    summary: 'Mark trip as scheduled (ready for fulfillment)',
    tags: ['Taxi fleet'],
    requestBody: { schema: tripScheduleSchema },
