...
import { TaxiFleetWeeklySettlement } from '@/modules/taxi_fleet/data/entities'
import { resolveDriverContext } from '@/modules/taxi_fleet/lib/driverContext'
import { serializeDriverSettlementDetail } from '@/modules/taxi_fleet/lib/driverSettlements'
...
export async function GET(req: Request, ctx: { params: Promise<{ id?: string }> | { id?: string } }) {
  try {
    ...
    return NextResponse.json(serializeDriverSettlementDetail(row))
  } catch (err) {
