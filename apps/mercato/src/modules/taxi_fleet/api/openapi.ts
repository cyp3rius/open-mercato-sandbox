...
const buildTaxiFleetCrudOpenApi = createCrudOpenApiFactory({
  defaultTag: 'Taxi fleet',
...
export function createTaxiFleetCrudOpenApi(options: CrudOpenApiOptions) {
  return buildTaxiFleetCrudOpenApi(options)
}
