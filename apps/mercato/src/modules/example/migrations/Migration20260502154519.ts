...
export class Migration20260502154519 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`alter table if exists "procurement_process_supplier_line_items" drop constraint if exists "procurement_supplier_line_line_fk";`);

    this.addSql(`alter table if exists "procurement_process_supplier_line_items" drop constraint if exists "procurement_supplier_line_supplier_fk";`);

    this.addSql(`alter table if exists "procurement_process_tasks" drop constraint if exists "procurement_process_tasks_supplier_id_foreign";`);
    ...
    this.addSql(`alter table if exists "procurement_process_tasks" drop constraint if exists "procurement_process_tasks_process_id_foreign";`);
    ...
    this.addSql(`alter table if exists "resources_resource_accessory_links" drop constraint if exists "resources_resource_accessory_links_accessory_resource_id_foreig";`);
    ...
    this.addSql(`alter table if exists "procurement_processes" drop constraint if exists "procurement_processes_handler_user_id_foreign";`);
  }
