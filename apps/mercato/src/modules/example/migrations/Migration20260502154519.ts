...
export class Migration20260502154519 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`alter table "procurement_process_suppliers" drop constraint if exists "procurement_process_suppliers_vendor_customer_entity_id_foreign";`);
    ...
    this.addSql(`alter table "insurance_policies" drop constraint if exists "insurance_policies_insurer_contact_id_foreign";`);

    this.addSql(`alter table "insurance_insurer_contacts" drop constraint if exists "insurance_insurer_contacts_insurer_id_foreign";`);

    this.addSql(`alter table "insurance_policies" drop constraint if exists "insurance_policies_insurer_id_foreign";`);

    this.addSql(`alter table "procurement_process_supplier_line_items" drop constraint if exists "procurement_supplier_line_line_fk";`);

    this.addSql(`alter table "procurement_process_supplier_line_items" drop constraint if exists "procurement_supplier_line_supplier_fk";`);

    this.addSql(`alter table "procurement_process_tasks" drop constraint if exists "procurement_process_tasks_supplier_id_foreign";`);

    this.addSql(`alter table "procurement_process_line_items" drop constraint if exists "procurement_process_line_items_process_id_foreign";`);

    this.addSql(`alter table "procurement_process_suppliers" drop constraint if exists "procurement_process_suppliers_process_id_foreign";`);

    this.addSql(`alter table "procurement_process_tasks" drop constraint if exists "procurement_process_tasks_process_id_foreign";`);

    this.addSql(`alter table "procurement_process_timeline_events" drop constraint if exists "procurement_process_timeline_events_process_id_foreign";`);

    this.addSql(`alter table "procurement_process_line_items" drop constraint if exists "procurement_process_line_items_resource_id_foreign";`);

    this.addSql(`alter table "resources_resource_accessory_links" drop constraint if exists "resources_resource_accessory_links_accessory_resource_id_foreig";`);

    this.addSql(`alter table "resources_resource_accessory_links" drop constraint if exists "resources_resource_accessory_links_host_resource_id_foreign";`);

    this.addSql(`alter table "resources_resource_service_book_entries" drop constraint if exists "resources_resource_service_book_entries_resource_id_foreign";`);
    ...
    this.addSql(`alter table "procurement_processes" drop constraint if exists "procurement_processes_handler_user_id_foreign";`);
  }
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`create table "procurement_process_tasks" ("id" uuid not null default gen_random_uuid(), "tenant_id" uuid not null, "organization_id" uuid not null, "process_id" uuid not null, "supplier_id" uuid null, "title" text not null, "body" text null, "task_status" text not null default 'open', "due_at" timestamptz(6) null, "assigned_user_id" uuid null, "delegated_from_user_id" uuid null, "source_action_value" text null, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, "deleted_at" timestamptz(6) null, constraint "procurement_process_tasks_pkey" primary key ("id"));`);
    this.addSql(`create index "procurement_process_tasks_assignee_idx" on "procurement_process_tasks" ("assigned_user_id");`);
    this.addSql(`create index "procurement_process_tasks_process_idx" on "procurement_process_tasks" ("process_id");`);
    ...
    this.addSql(`alter table "procurement_process_supplier_line_items" add constraint "procurement_supplier_line_line_fk" foreign key ("line_item_id") references "procurement_process_line_items" ("id") on update cascade on delete cascade;`);
    this.addSql(`alter table "procurement_process_supplier_line_items" add constraint "procurement_supplier_line_supplier_fk" foreign key ("supplier_id") references "procurement_process_suppliers" ("id") on update cascade on delete cascade;`);
    ...
    this.addSql(`alter table "procurement_process_tasks" add constraint "procurement_process_tasks_process_id_foreign" foreign key ("process_id") references "procurement_processes" ("id") on update cascade on delete no action;`);
    this.addSql(`alter table "procurement_process_tasks" add constraint "procurement_process_tasks_supplier_id_foreign" foreign key ("supplier_id") references "procurement_process_suppliers" ("id") on update cascade on delete set null;`);
    ...
    this.addSql(`alter table "procurement_processes" add constraint "procurement_processes_handler_user_id_foreign" foreign key ("handler_user_id") references "users" ("id") on update cascade on delete set null;`);

    this.addSql(`alter table "resources_resource_accessory_links" add constraint "resources_resource_accessory_links_accessory_resource_id_foreig" foreign key ("accessory_resource_id") references "resources_resources" ("id") on update cascade on delete no action;`);
