...
export const enabledModules: ModuleEntry[] = [
  ...
  { id: 'customer_signals', from: '@open-mercato/core' },
  { id: 'cases', from: '@open-mercato/core' },
  { id: 'playbooks', from: '@open-mercato/core' },
  { id: 'partner_programs', from: '@open-mercato/core' },
  ...
  { id: 'accounting', from: '@open-mercato/core' },
  { id: 'planner', from: '@open-mercato/core' },
  { id: 'resources', from: '@open-mercato/core' },
  { id: 'procurement', from: '@open-mercato/core' },
  ...
  { id: 'storage_google_drive', from: '@open-mercato/storage-google-drive' },
